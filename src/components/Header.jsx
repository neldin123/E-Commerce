  ...
  return (
    <header className="w-full shadow-lg shadow-indigo-700/20">
      <div className="container mx-auto max-w-7xl">
        <div className="flex items-center px-15 h-20 justify-between ">
          ...
          <div className="max-xl:hidden">
            <div className="relative">
              ...
              <input
                type="text"
                className="outline-2 outline-gray-400 rounded-xl px-5 py-1 pl-10 relative caret-indigo-700 focus:outline-indigo-700 text-l w-100"
